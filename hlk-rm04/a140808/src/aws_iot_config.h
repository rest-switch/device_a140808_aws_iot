...
#define AWS_IOT_MY_REGION_NAME         ""     ///< amazon region
...
#define MAX_SIZE_OF_THING_NAME 10                     ///< The Thing Name should not be bigger than this value. Modify this if the Thing Name needs to be bigger
